...
public class UploadManager {
    ...
    public static void initContentTypeListMap() throws UploadException {
        ...
        InputStream inputStream = classLoader.getResourceAsStream(CONTENT_TYPE_PROPERTY_FILE);
        ...
        try {
            ...
            while (names.hasMoreElements()) {
                ...
                String[] typeArray = StringArray.splitSpaceLessNames(property, ",");
    ...
    public static String uploadFileAndGetAbsolutePath(
        ...
        String prefix = "." + uploadType + "." + contentType + ".";
        String postfix = "." + sessionId;
        try {
            ...
            byte[] outputFilePath = outputFile.getAbsolutePath().getBytes(charsetUtf8);
            return "filePath=" + new String(outputFilePath, charsetLatin1);
        } catch (IOException e) {
            throw new UploadException(e.getCause());
        }
    }
