 ...
 * service-ms
 */
public class LoginJdbcDao_ extends JdbcDao_ {

    private static final Logger LOGGER = LoggerFactory.getLogger(LoginJdbcDao_.class);

    private static final String DEFAULT_TABLE = "\"Login\"";
    private static final String DEFAULT_JOIN_COLUMN = "id";
    private static final String RESTORE_TABLE = "\"Restore\"";
    private static final String RESTORE_JOIN_COLUMN = "login_id";

    public LoginJdbcDao_(Connection connection) throws DaoException {
        super(connection);
    }
...
//        if (entityName.equals(Login.class.getSimpleName())) {
//            return new JdbcParameter.Column(DEFAULT_TABLE, entityProperty.toString().toLowerCase());
//        } else if (entityName.equals(Restore.class.getSimpleName())) {
//            if (entityProperty.equals(Restore.Property.LOGIN)) {
//                return new JdbcParameter.Column(RESTORE_TABLE, RESTORE_JOIN_COLUMN);
//            } else {
//
//            }
//        }
...
//        if (joinTableName.equals(RESTORE_TABLE)) {
//            return new JdbcParameter.Field(
//                    null,
//                    new JdbcParameter.Column(DEFAULT_TABLE, DEFAULT_JOIN_COLUMN),
//                    new JdbcParameter.Column(RESTORE_TABLE, RESTORE_JOIN_COLUMN)
//            );
//        }
