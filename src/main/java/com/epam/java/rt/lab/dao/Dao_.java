...
//    Long count(Parameter_ parameter) throws DaoException;
//
//    <T> List<T> getAll(Parameter_ parameter) throws DaoException;
//
//    <T> T getFirst(Parameter_ parameter) throws DaoException;
