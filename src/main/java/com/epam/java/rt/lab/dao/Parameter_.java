...
//    }
//
//    public Parameter_ values(Field... fieldArray) {
//        this.parameterMap.put(ParameterType.SET_FIELD_ARRAY, fieldArray);
//        return this;
//    }
//
//    public Parameter_ filter(Field... fieldArray) {
...
//        if (split.length == 1) {
//            result[1] = ".".concat(Parameter_.getColumnName(split[0]));
//        } else if (split.length == 2) {
//            result[0] = "\"".concat(split[0].substring(0, 1).toUpperCase()).concat(split[0].substring(1)).concat("\"");
//            result[1] = result[0].concat(".").concat(Parameter_.getColumnName(split[1]));
//        }
//        return result;
//    }
//
