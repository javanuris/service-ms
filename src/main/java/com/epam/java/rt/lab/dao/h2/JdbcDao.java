...
//            preparedStatementMethodMap.put(Timestamp.class, PreparedStatement.class.getMethod("setTimestamp", int.class, Timestamp.class));
    ...
    PreparedStatement rawQuery(String sqlQuery, List<Column> columnList) throws DaoException {
        return rawQuery(sqlQuery, columnList, PreparedStatement.NO_GENERATED_KEYS);
    }

    PreparedStatement rawQuery(String sqlQuery, List<Column> columnList, int autoGeneratedKeys) throws DaoException {
        PreparedStatement preparedStatement = getPreparedStatement
                (JdbcDao.preparedStatementMap, sqlQuery, autoGeneratedKeys);
