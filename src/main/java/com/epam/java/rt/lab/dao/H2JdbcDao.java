...
public abstract class H2JdbcDao implements Dao {
    ...
    private static Map<Type, Method> preparedStatementMethodMap;
    ...
    private void setPreparedStatementMethodMap() throws DaoException {
        try {
            if (preparedStatementMethodMap == null) {
...
//            preparedStatementMethodMap.put(Timestamp.class, PreparedStatement.class.getMethod("setTimestamp", int.class, Timestamp.class));
    ...
    public static String getDaoReadBy() {
        return daoReadBy;
    }

    public static Method getPreparedStatementMethod(Type type) {
        return preparedStatementMethodMap.get(type);
    }
