...
//                view.getControl(2).setAction(UrlManager.getContextUri(req, "/access/role/edit",
//                        UrlManager.getRequestParameterString(parameterMap), "id=".concat(id)));
//                view.getControl(3).setAction(UrlManager.getContextUri(req, "/access/role/list", parameterMap));
//                req.setAttribute("viewRole", view);
//                req.getRequestDispatcher("/WEB-INF/jsp/access/role/view.jsp").forward(req, resp);
//            }
